  ...
  return (
    <section id="offres" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-start">
        ...
        {/* Offre mensuelle sans engagement (avec style de paiement complet) */}
        <Card className="bg-white border-2 border-orange-500 hover:border-green-500 transition-all duration-300 hover:shadow-xl relative">
          ...
          <CardHeader className="text-center pb-4 pt-6">
            <CardTitle className="text-2xl font-bold text-black">Sans engagement</CardTitle>
            <CardDescription className="text-gray-600">Flexibilité totale avec hébergement</CardDescription>
        ...
        {/* Offre paiement complet (avec style de l’offre mensuelle) */}
        <Card className="bg-white border-2 border-gray-200 hover:border-green-500 transition-all duration-300 hover:shadow-lg">
          <CardHeader className="text-center pb-4 pt-6">
            <CardTitle className="text-2xl font-bold text-black">Paiement complet</CardTitle>
            <CardDescription className="text-gray-600">Un seul paiement, site entièrement à vous</CardDescription>
            <div className="text-center py-4">
